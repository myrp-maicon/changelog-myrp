...
## Conta bloqueada
Na página de conta bloqueada por inadimplência será exibido o e-mail e telefone configurado no campo "Parceiro é o responsável pela cobrança?" no cadastro do parceiro.
