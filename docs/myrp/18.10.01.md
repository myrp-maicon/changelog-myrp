...
* Alterada a integração com o eDocs para salvar a logo do clienter. Agora passa a ser integrada imediatamente via API, não precisando esperar a sincronia de arquivos.
